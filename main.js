...
const text = {
    ...
    'Kanada': '<p>Kanada war Britische und Französische (Siedlungs-)Kolonie, weil beide Länder verfeindet waren gab es immer wieder Kämpfe um Kanada.</p><p>Kanada ist auch einer der Staaten, die immer noch die Britische Queen als Königinn haben.</p>',
